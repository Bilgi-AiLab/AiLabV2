...
def tsne_graph_2d(output, topic_names, doc_names, algorithm):
    ...
    colorArray = [
        "#63b598", "#ce7d78", "#ea9e70", "#0d5ac1",
        "#14a9ad", "#4ca2f9", "#d298e2", "#6119d0", "#d2737d", 
        "#c0a43c", "#f2510e", "#651be6", "#79806e", "#cd2f00", 
        "#9348af", "#c5a4fb", "#996635", "#b11573", "#4bb473", 
        "#75d89e", "#2f3f94", "#2f7b99", "#da967d", "#34891f", 
        "#ca4751", "#4b5bdc", "#250662", "#cb5bea", "#228916",
        "#ac3e1b", "#df514a", "#539397", "#880977", "#f697c1"
    ]
    colorArrayy = np.array(colorArray)
    ...
    # Update layout to add camera icon for export
    fig.update_layout(
        ...
        dragmode='pan',
        modebar_add=['toImage'],  # Add "Save as Image" button
    )
    
    # Return the HTML plot
    html_plot = plotly.offline.plot(fig, output_type='div')
    return html_plot
